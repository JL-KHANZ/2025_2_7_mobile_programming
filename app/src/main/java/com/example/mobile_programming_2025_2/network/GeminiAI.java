...
public class GeminiAI {
    ...
    public void generateFeedback(String userText, Executor executor, FeedbackCallback callback) {
        String prompt = "다음 글의 감정을 공감하고 개선할 수 있는 마인드셋 방법 1가지와 생활 루틴 2개를 짧게 추천해줘. " + "결과는 반드시 JSON 형식으로 '공감', '마인드셋 방법', '생활 루틴 1', '생활 루틴 2'를 key로, 각각에 해당하는 내용을 value로 반환해줘. 다른 부가적인 설명은 절대 추가하지 마. " + "예시: {\\\"공감\\\": \\\"...\\\", \\\"마인드셋 방법\\\": \\\"...\\\", \\\"생활 루틴 1\\\": \\\"...\\\", \\\"생활 루틴 2\\\": \\\"...\\\"}. " + "분석할 글: \"" + userText + "\"";
